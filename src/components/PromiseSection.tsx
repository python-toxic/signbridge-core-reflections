      ...
      <div className="max-w-6xl mx-auto px-8 text-center">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-24">
          {promises.map((promise, index) => (
            ...
            >
              <h2 className="font-playfair text-4xl md:text-5xl font-bold text-reflective-burgundy">
                {promise.title}
              </h2>
              <p className="font-inter text-lg text-reflective-burgundy/70 font-light leading-relaxed max-w-sm mx-auto">
                {promise.description}
              </p>
            </motion.div>
          ))}
