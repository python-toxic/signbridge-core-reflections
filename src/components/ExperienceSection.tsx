...
export const ExperienceSection = () => {
  return (
    <section id="experience" className="min-h-screen bg-reflective-navy flex items-center justify-center scroll-section relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-8 text-center">
        ...
        >
          <motion.h2
            className="font-playfair text-5xl md:text-6xl font-bold text-reflective-cream leading-tight"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mt-20">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="font-playfair text-3xl font-bold text-reflective-cream">
                Real-Time Recognition
              </h3>
              <p className="font-inter text-lg text-reflective-cream/80 font-light leading-relaxed">
